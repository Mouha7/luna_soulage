...
const TestimonialPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs.send(serviceId, templateId, templateParams, publicKey)
            .then((response) => {
                console.log('Témoignage envoyé avec succès!', response.status, response.text);
                setNotificationType('success');
                setNotificationMessage('Merci pour votre témoignage ! Il sera publié après modération.');
            ...
            .catch((error) => {
                console.error("Erreur lors de l'envoi du témoignage", error.text);
                setNotificationType('error');
                setNotificationMessage('Une erreur est survenue. Veuillez réessayer plus tard.');
                setShowNotification(true);
